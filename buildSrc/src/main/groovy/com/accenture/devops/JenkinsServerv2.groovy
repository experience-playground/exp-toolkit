...
public class JenkinsServerv2 implements Closeable {
    private final Logger LOGGER = LoggerFactory.getLogger(getClass());
         ...
         */
        public JenkinsServerv2(URI serverUri) {
         ...
         */
        public JenkinsServerv2(URI serverUri, String username, String passwordOrToken) {
         ...
         */
        public JenkinsServerv2(final JenkinsHttpConnection client) {
            this.client = client;
        }
